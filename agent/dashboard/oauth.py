"""Provider-neutral signed-JWT session cookie helpers for the dashboard."""
...
def build_settings_url() -> str | None:
    ...
    This is a plain, token-free link: it carries no per-user identity. The user
    signs in from their own session on the settings page.
    """
