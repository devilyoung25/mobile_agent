...
const NAV: Array<NavItem> = [
  { to: "/my-settings", label: "Configuración del perfil", icon: IoOptionsOutline },
  { to: "/cloud-agents", label: "Agente en la nube", icon: IoCloudOutline },
  { to: "/review", label: "Pull Requests", icon: IoGitPullRequestOutline },
  { to: "/usage", label: "Uso", icon: IoStatsChartOutline },
  { to: "/admin", label: "Administración", icon: IoSettingsOutline, adminOnly: true },
];
